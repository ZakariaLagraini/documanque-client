...
const Announcement = () => {
    ...
    async function fetchAnnouncement() {
        const response = await fetch('https://documanque-server.onrender.com/annonce/getAnnonceById?id=' + query.get("id"));
        return response.json();
    }

    async function fetchComments() {
        const response = await fetch('https://documanque-server.onrender.com/commentaire/getCommentairesByAnnonce?id=' + query.get("id"));
        return response.json();
    }
